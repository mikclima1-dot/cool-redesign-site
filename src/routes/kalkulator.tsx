...
const faqs = [
  {
    ...
    answer:
      "Мощността се определя от обема на помещението (площ × височина на тавана), ориентацията на прозорците и качеството на изолацията. Стандартната норма е около 260 BTU на кубичен метър, която се коригира според конкретните условия.",
  },
  {
  ...
  head: () => ({
    meta: [
      { title: "Калкулатор за мощност на климатик | MIK Clima" },
      {
        name: "description",
        content:
          "Безплатен калкулатор за изчисляване на нужната мощност на климатик според площ, височина на тавана, ориентация и изолация. Получете оферта от MIK Clima.",
      },
      {
        name: "keywords",
        content:
